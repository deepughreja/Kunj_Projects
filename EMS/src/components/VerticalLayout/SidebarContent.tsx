          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/#" className="has-arrow">
                <Icon name="grid" />
                <span>{props.t("Admin Apps")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
                  <Link to="/apps-calendar">{props.t("Exam Calendar")}</Link>
                </li>
                <li>
                ...
                <li>
                  ...
                  <ul className="sub-menu">
                    <li>
                      <Link to="/contacts-grid">{props.t("Student Grid")}</Link>
                    </li>
                    <li>
                      <Link to="/contacts-list">{props.t("Student List")}</Link>
                    </li>
                    <li>
            ...
            <li>
              <Link to="/#" className="has-arrow ">
                <Icon name="sliders" />
                <span>{props.t("Exam Management")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
                ...
                <li>
                  <Link to="/form-validation">{props.t("Add Exam")}</Link>
                </li>
                <li>
                  <Link to="/tables-datatable">{props.t("Exams")}</Link>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/add-role">{props.t("Add Role")}</Link>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/charts-apex">{props.t("Reports")}</Link>
                </li>
                <li>
                  <Link to="/charts-echart">{props.t("Reports 2")}</Link>
                </li>
                <li>
                  <Link to="/charts-chartjs">{props.t("Reports 3")}</Link>
                </li>
                <li>
                  <Link to="/charts-sparkline">{props.t("Reports 4")}</Link>
                </li>
              </ul>
            </li>
            <li>
              <Link to="/pages-pricing" className="">
                <Icon name="box" />
            ...
            <li>
              <Link to="/#" className="">
                ...
                <span>{props.t("Master Pages")}</span>
              </Link>
              <ul className="sub-menu">
                <li>
                ...
                <li>
                  <Link to="/form-uploads">{props.t("Student Marksheet Upload")} </Link>
                </li>
                <li>
            ...
            <div className="card-body">
              ...
              <div className="mt-4">
                ...
                <a href="#!" className="btn btn-primary mt-1">
                  <Icon name="twitter" className="icon-lg" /> Twitter
                </a>
                <a href="#!" className="btn btn-primary mt-1">
                  <Icon name="facebook" className="icon-lg" />Facebook
                </a>
