        ...
        <Container fluid>
          ...
          <Row>
            ...
            <Col xl={6}>
              <Card>
                <CardHeader>
                  <CardTitle>Total Vacancy by Role</CardTitle>
                </CardHeader>
                <CardBody>
                  <BarChart />
                </CardBody>
            ...
            <Col xl={6}>
              <Card>
                <CardHeader>
                  <CardTitle>Pass/Fail Result by exam </CardTitle>
                </CardHeader>
                <CardBody>
                  <Apaexlinecolumn />
                </CardBody>
          ...
          <Row>
            ...
            <Col xl={6}>
              <Card>
                <CardHeader>
                  <CardTitle>Passing Marks by Role</CardTitle>
                </CardHeader>
                <CardBody>
                  <DonutChart />
                </CardBody>
            ...
            <Col xl={6}>
              <Card>
                <CardHeader>
                  <CardTitle>Marks by category</CardTitle>
                </CardHeader>
                <CardBody>
                  <PieChart />
                </CardBody>
